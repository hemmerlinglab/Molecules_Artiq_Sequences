# Generated from 'v1_4_0.xml' on 2025-07-21 10:00:08.703709
...
class Laser:
    ...
    def detect(self) -> None:
        self.__client.exec(self.__name + ':detect')
...
class Lock:
    ...
    def start_scan(self) -> None:
        self.__client.exec(self.__name + ':start-scan')

    def stop_scan(self) -> None:
        self.__client.exec(self.__name + ':stop-scan')
