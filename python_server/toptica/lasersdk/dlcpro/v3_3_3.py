# Generated from 'v3_3_3.xml' on 2025-07-21 10:00:15.843550
...
class Laser:
    ...
    def save(self) -> None:
        self.__client.exec(self.__name + ':save')

    def load(self) -> None:
        self.__client.exec(self.__name + ':load')

    def load_head(self) -> None:
        self.__client.exec(self.__name + ':load-head')
...
class LaserHead:
    ...
    def store(self) -> None:
        self.__client.exec(self.__name + ':store')

    def restore(self) -> None:
        self.__client.exec(self.__name + ':restore')
...
class TcChannel1:
    ...
    def check_peltier(self) -> float:
        return self.__client.exec(self.__name + ':check-peltier', return_type=float)
...
class Lock:
    ...
    def show_candidates(self) -> Tuple[str, int]:
        return self.__client.exec(self.__name + ':show-candidates', output_type=str, return_type=int)

    def find_candidates(self) -> None:
        self.__client.exec(self.__name + ':find-candidates')
    ...
    def select_lockpoint(self, x: float, y: float, type_: int) -> None:
        ...
        self.__client.exec(self.__name + ':select-lockpoint', x, y, type_)

    def close(self) -> None:
        self.__client.exec(self.__name + ':close')

    def open(self) -> None:
        self.__client.exec(self.__name + ':open')
...
class AutoLir:
    ...
    def abort(self) -> None:
        self.__client.exec(self.__name + ':abort')
...
class ScbPowerOptimization:
    ...
    def start_optimization_all(self) -> int:
        return self.__client.exec(self.__name + ':start-optimization-all', return_type=int)

    def start_optimization_seed_probe(self) -> int:
        return self.__client.exec(self.__name + ':start-optimization-seed-probe', return_type=int)

    def start_optimization_amp(self) -> int:
        return self.__client.exec(self.__name + ':start-optimization-amp', return_type=int)

    def start_optimization_fiber(self) -> int:
        return self.__client.exec(self.__name + ':start-optimization-fiber', return_type=int)
...
class ScbStage:
    ...
    def start_optimization(self) -> int:
        return self.__client.exec(self.__name + ':start-optimization', return_type=int)
...
class ServoControlServosNamed:
    ...
    def center_probe_servos(self) -> None:
        self.__client.exec(self.__name + ':center-probe-servos')

    def center_ta_servos(self) -> None:
        self.__client.exec(self.__name + ':center-ta-servos')

    def center_fiber_servos(self) -> None:
        self.__client.exec(self.__name + ':center-fiber-servos')

    def center_all_servos(self) -> None:
        self.__client.exec(self.__name + ':center-all-servos')

    def enable_all_servos(self) -> None:
        self.__client.exec(self.__name + ':enable-all-servos')

    def disable_all_servos(self) -> None:
        self.__client.exec(self.__name + ':disable-all-servos')
...
class ServoControlServo:
    ...
    def center_servo(self) -> None:
        self.__client.exec(self.__name + ':center-servo')
...
class DlMotorStepper:
    ...
    def perform_referencing(self) -> None:
        self.__client.exec(self.__name + ':perform-referencing')

    def reset_cycles(self) -> None:
        self.__client.exec(self.__name + ':reset-cycles')
...
class DlMotorScan:
    ...
    def pause(self) -> None:
        self.__client.exec(self.__name + ':pause')

    def continue_(self) -> None:
        self.__client.exec(self.__name + ':continue')
...
class DlMotorCalibration:
    ...
    def set(self, fit_a: float, fit_b: float, fit_c: float, wavelength_min: float, wavelength_max: float) -> None:
        ...
        self.__client.exec(self.__name + ':set', fit_a, fit_b, fit_c, wavelength_min, wavelength_max)
...
class LhFactory:
    ...
    def retrieve_now(self) -> None:
        self.__client.exec(self.__name + ':retrieve-now')

    def update_service_date(self) -> None:
        self.__client.exec(self.__name + ':update-service-date')
...
class CtlOptimizationT:
    ...
    def smile(self) -> None:
        self.__client.exec(self.__name + ':smile')

    def flow(self) -> None:
        self.__client.exec(self.__name + ':flow')
...
class CtlMotorCalibration:
    ...
    def shift_wavelength(self, target_wavelength: float) -> None:
        ...
        self.__client.exec(self.__name + ':shift-wavelength', target_wavelength)

    def reset_shift(self) -> None:
        self.__client.exec(self.__name + ':reset-shift')
...
class WideScan:
    ...
    def set_output_to_zoom_offset(self) -> None:
        self.__client.exec(self.__name + ':set-output-to-zoom-offset')

    def set_scan_range_to_zoom_range(self) -> None:
        self.__client.exec(self.__name + ':set-scan-range-to-zoom-range')

    def set_zoom_range_to_scan_range(self) -> None:
        self.__client.exec(self.__name + ':set-zoom-range-to-scan-range')
...
class RecorderData:
    ...
    def zoom_out(self) -> None:
        self.__client.exec(self.__name + ':zoom-out')
    ...
    def get_data(self, start_index: int, count: int) -> bytes:
        ...
        return self.__client.exec(self.__name + ':get-data', start_index, count, return_type=bytes)

    def show_data(self, start_index: int, count: int) -> None:
        assert isinstance(start_index, int), f"expected type 'int' for parameter 'start_index', got '{type(start_index)}'"
        assert isinstance(count, int), f"expected type 'int' for parameter 'count', got '{type(count)}'"
        self.__client.exec(self.__name + ':show-data', start_index, count)

    def clear_data(self) -> None:
        self.__client.exec(self.__name + ':clear-data')
...
class NloLaserHeadServos:
    ...
    def center_shg_servos(self) -> None:
        self.__client.exec(self.__name + ':center-shg-servos')

    def center_fhg_servos(self) -> None:
        self.__client.exec(self.__name + ':center-fhg-servos')
...
class NloPowerOptimization:
    ...
    def start_optimization_shg(self) -> int:
        return self.__client.exec(self.__name + ':start-optimization-shg', return_type=int)

    def start_optimization_fiber(self) -> int:
        return self.__client.exec(self.__name + ':start-optimization-fiber', return_type=int)

    def start_optimization_fhg(self) -> int:
        return self.__client.exec(self.__name + ':start-optimization-fhg', return_type=int)
...
class AutoNlo:
    ...
    def perform_single_mode_optimization(self) -> None:
        self.__client.exec(self.__name + ':perform-single-mode-optimization')

    def perform_auto_align(self) -> None:
        self.__client.exec(self.__name + ':perform-auto-align')

    def reset_operation_time_cavity(self) -> None:
        self.__client.exec(self.__name + ':reset-operation-time-cavity')

    def reset_operation_time_cavity_fhg(self) -> None:
        self.__client.exec(self.__name + ':reset-operation-time-cavity-fhg')
...
class NloLaserHeadLocalOscillatorShg1:
    ...
    def auto_pdh(self) -> None:
        self.__client.exec(self.__name + ':auto-pdh')

    def auto_pdh_abort(self) -> None:
        self.__client.exec(self.__name + ':auto-pdh-abort')
...
class NloLaserHeadMicronixMotor:
    ...
    def recalibrate(self) -> None:
        self.__client.exec(self.__name + ':recalibrate')
...
class UvShg:
    ...
    def perform_optics_shift(self) -> None:
        self.__client.exec(self.__name + ':perform-optics-shift')
...
class LaserConfig:
    ...
    def import_(self, input_stream: bytes) -> None:
        ...
        self.__client.exec(self.__name + ':import', input_stream=input_stream)

    def export(self) -> bytes:
        return self.__client.exec(self.__name + ':export', output_type=bytes)

    def retrieve(self) -> None:
        self.__client.exec(self.__name + ':retrieve')

    def apply(self) -> bool:
        return self.__client.exec(self.__name + ':apply', return_type=bool)

    def show(self) -> str:
        return self.__client.exec(self.__name + ':show', output_type=str)

    def list(self) -> str:
        return self.__client.exec(self.__name + ':list', return_type=str)
...
class LaserDiagnosis:
    ...
    def print_result(self) -> bytes:
        return self.__client.exec(self.__name + ':print-result', output_type=bytes)

    def execute(self) -> bytes:
        return self.__client.exec(self.__name + ':execute', output_type=bytes)

    def generate_to_usb(self) -> None:
        self.__client.exec(self.__name + ':generate-to-usb')
...
class LaserCommon:
    ...
    def save_all(self) -> None:
        self.__client.exec(self.__name + ':save-all')

    def load_all(self) -> None:
        self.__client.exec(self.__name + ':load-all')

    def store_all(self) -> None:
        self.__client.exec(self.__name + ':store-all')

    def restore_all(self) -> None:
        self.__client.exec(self.__name + ':restore-all')

    def apply_all(self) -> None:
        self.__client.exec(self.__name + ':apply-all')

    def retrieve_all(self) -> None:
        self.__client.exec(self.__name + ':retrieve-all')
...
class ScanSynchronization:
    ...
    def sync(self) -> None:
        self.__client.exec(self.__name + ':sync')
...
class Display:
    ...
    def update_state(self, active: bool) -> None:
        ...
        self.__client.exec(self.__name + ':update-state', active)
...
class PfdEventDetector:
    ...
    def reset_counter(self) -> None:
        self.__client.exec(self.__name + ':reset-counter')

    def reset_indicator(self) -> None:
        self.__client.exec(self.__name + ':reset-indicator')
...
class SystemMessages:
    ...
    def mark_as_read(self, id_: int) -> None:
        ...
        self.__client.exec(self.__name + ':mark-as-read', id_)

    def show_all(self) -> str:
        return self.__client.exec(self.__name + ':show-all', output_type=str)

    def show_new(self) -> str:
        return self.__client.exec(self.__name + ':show-new', output_type=str)

    def show_log(self) -> str:
        return self.__client.exec(self.__name + ':show-log', output_type=str)

    def show_persistent(self) -> str:
        return self.__client.exec(self.__name + ':show-persistent', output_type=str)
...
class Licenses:
    ...
    def get_key(self, key_number: int) -> str:
        ...
        return self.__client.exec(self.__name + ':get-key', key_number, return_type=str)
    ...
    def install(self, licensekey: str) -> bool:
        ...
        return self.__client.exec(self.__name + ':install', licensekey, return_type=bool)
...
class FwUpdate:
    ...
    def upload(self, input_stream: bytes, filename: str) -> None:
        ...
        self.__client.exec(self.__name + ':upload', filename, input_stream=input_stream)

    def show_log(self) -> str:
        return self.__client.exec(self.__name + ':show-log', output_type=str)

    def show_history(self) -> str:
        return self.__client.exec(self.__name + ':show-history', output_type=str)
...
class ServiceReport:
    ...
    def service_report(self) -> bytes:
        return self.__client.exec(self.__name + ':service-report', output_type=bytes)

    def request(self) -> None:
        self.__client.exec(self.__name + ':request')

    def add_info(self, text: str) -> None:
        assert isinstance(text, str), f"expected type 'str' for parameter 'text', got '{type(text)}'"
        self.__client.exec(self.__name + ':add-info', text)

    def print(self) -> bytes:
        return self.__client.exec(self.__name + ':print', output_type=bytes)

    def save_to_usb(self) -> None:
        self.__client.exec(self.__name + ':save-to-usb')
...
class Ipconfig:
    ...
    def set_ip_gateway(self, ip_addr: str, net_mask: str, gateway: str) -> None:
        ...
        self.__client.exec(self.__name + ':set-ip-gateway', ip_addr, net_mask, gateway)
...
class DLCpro:
    ...
    def system_connections(self) -> Tuple[str, int]:
        return self.__client.exec('system-connections', output_type=str, return_type=int)

    def debug_log(self) -> str:
        return self.__client.exec('debug-log', output_type=str)

    def error_log(self) -> str:
        return self.__client.exec('error-log', output_type=str)

    def service_log(self) -> str:
        return self.__client.exec('service-log', output_type=str)

    def service_script(self, input_stream: bytes) -> None:
        assert isinstance(input_stream, bytes), f"expected type 'bytes' for parameter 'input_stream', got '{type(input_stream)}'"
        self.__client.exec('service-script', input_stream=input_stream)

    def service_script_from_usb(self) -> None:
        self.__client.exec('service-script-from-usb')

    def service_report(self) -> bytes:
        return self.__client.exec('service-report', output_type=bytes)

    def output_signals_report(self) -> None:
        self.__client.exec('output-signals-report')

    def system_summary(self) -> str:
        return self.__client.exec('system-summary', output_type=str)

    def system_summary_ontimes(self) -> str:
        return self.__client.exec('system-summary-ontimes', output_type=str)
    ...
    def change_password(self, password: str) -> None:
        ...
        self.__client.exec('change-password', password)

    def change_password_service(self, password: str) -> None:
        assert isinstance(password, str), f"expected type 'str' for parameter 'password', got '{type(password)}'"
        self.__client.exec('change-password-service', password)
