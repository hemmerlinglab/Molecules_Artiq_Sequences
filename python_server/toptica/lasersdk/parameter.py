...
if TYPE_CHECKING:
    ...
    from .client import DecopCallback
...
class DecopBoolean:
    ...
    def subscribe(self, callback: DecopCallback, interval: Optional[int] = None) -> Subscription:
        ...
        """
        return self._client.subscribe(self._name, callback, bool, interval)
...
class DecopInteger:
    ...
    def subscribe(self, callback: DecopCallback, interval: Optional[int] = None,
                  threshold: Optional[int] = None) -> Subscription:
        """Creates a subscription to the value changes of the parameter.

        Args:
            callback (DecopCallback): A callback that will be invoked when the value of the parameter has changed.
            interval (Optional[int]): The minimum update interval (in milliseconds).
            threshold (Optional[int]): The minimum change of the value for an update.

        Returns:
            Subscription: A subscription to the value changes of the parameter.

        """
        return self._client.subscribe(self._name, callback, int, interval, threshold)
...
class DecopReal:
    ...
    def subscribe(self, callback: DecopCallback, interval: Optional[int] = None,
        ...
        Args:
            callback (DecopCallback): A callback that will be invoked when the value of the parameter has changed.
            interval (Optional[int]): The minimum update interval (in milliseconds).
            threshold (Optional[float]): The minimum change of the value for an update.

        Returns:
            Subscription: A subscription to the value changes of the parameter.

        """
        return self._client.subscribe(self._name, callback, float, interval, threshold)
...
class DecopString:
    ...
    def subscribe(self, callback: DecopCallback, interval: Optional[int] = None) -> Subscription:
        ...
        """
        return self._client.subscribe(self._name, callback, str, interval)
...
class DecopBinary:
    ...
    def subscribe(self, callback: DecopCallback, interval: Optional[int] = None) -> Subscription:
        ...
        """
        return self._client.subscribe(self._name, callback, bytes, interval)
