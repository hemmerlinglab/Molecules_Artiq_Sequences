...
class Client:
    ...
    Args:
        connection (Connection):
            A connection that is used to communicate with the device.
...
class Subscription:
    ...
    Args:
        ...
        callback (DecopCallback):
            A callback that will be invoked when the value of the parameter has changed.
