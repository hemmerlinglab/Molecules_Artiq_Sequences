# Generated from 'v3_3_3.xml' on 2025-07-21 10:00:24.767241
...
class Laser:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._label = MutableDecopString(client, name + ':label')
        self._emission = DecopBoolean(client, name + ':emission')
        self._enabled = MutableDecopBoolean(client, name + ':enabled')
        self._enabled_valid = DecopBoolean(client, name + ':enabled-valid')
        ...
        self._daq_connected = MutableDecopBoolean(client, name + ':daq-connected')
        ...
        self._hf_cavity = HfCavity(client, name + ':hf-cavity')
    ...
    @property
    def label(self) -> 'MutableDecopString':
        return self._label
    ...
    @property
    def enabled_valid(self) -> 'DecopBoolean':
        return self._enabled_valid
    ...
    @property
    def daq_connected(self) -> 'MutableDecopBoolean':
        return self._daq_connected
    ...
    @property
    def hf_cavity(self) -> 'HfCavity':
        return self._hf_cavity
    ...
    async def load_head(self) -> None:
        await self.__client.exec(self.__name + ':load-head')
...
class LaserHead:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._servo = ServoControlServosNamed(client, name + ':servo')
    ...
    @property
    def servo(self) -> 'ServoControlServosNamed':
        return self._servo
    ...
    async def restore(self) -> None:
        await self.__client.exec(self.__name + ':restore')
...
class TcChannel1:
    ...
    async def check_peltier(self) -> float:
        return await self.__client.exec(self.__name + ':check-peltier', return_type=float)
...
class Lock:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._di_hold_enabled = MutableDecopBoolean(client, name + ':di-hold-enabled')
    ...
    @property
    def di_hold_enabled(self) -> 'MutableDecopBoolean':
        return self._di_hold_enabled
    ...
    async def show_candidates(self) -> Tuple[str, int]:
        return await self.__client.exec(self.__name + ':show-candidates', output_type=str, return_type=int)

    async def find_candidates(self) -> None:
        await self.__client.exec(self.__name + ':find-candidates')
    ...
    async def select_lockpoint(self, x: float, y: float, type_: int) -> None:
        ...
        await self.__client.exec(self.__name + ':select-lockpoint', x, y, type_)

    async def close(self) -> None:
        await self.__client.exec(self.__name + ':close')

    async def open(self) -> None:
        await self.__client.exec(self.__name + ':open')
...
class AutoLir:
    ...
    async def abort(self) -> None:
        await self.__client.exec(self.__name + ':abort')
...
class AlCandidateFilter:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._top_of_fringe_low_pass = MutableDecopBoolean(client, name + ':top-of-fringe-low-pass')
    ...
    @property
    def top_of_fringe_low_pass(self) -> 'MutableDecopBoolean':
        return self._top_of_fringe_low_pass
...
class ScbPowerOptimization:
    ...
    async def start_optimization_all(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization-all', return_type=int)

    async def start_optimization_seed_probe(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization-seed-probe', return_type=int)

    async def start_optimization_amp(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization-amp', return_type=int)

    async def start_optimization_fiber(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization-fiber', return_type=int)
...
class ScbStage:
    ...
    async def start_optimization(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization', return_type=int)
...
class ServoControlServosNamed:
    ...
    async def center_probe_servos(self) -> None:
        await self.__client.exec(self.__name + ':center-probe-servos')

    async def center_ta_servos(self) -> None:
        await self.__client.exec(self.__name + ':center-ta-servos')

    async def center_fiber_servos(self) -> None:
        await self.__client.exec(self.__name + ':center-fiber-servos')

    async def center_all_servos(self) -> None:
        await self.__client.exec(self.__name + ':center-all-servos')

    async def enable_all_servos(self) -> None:
        await self.__client.exec(self.__name + ':enable-all-servos')

    async def disable_all_servos(self) -> None:
        await self.__client.exec(self.__name + ':disable-all-servos')
...
class ServoControlServo:
    ...
    async def center_servo(self) -> None:
        await self.__client.exec(self.__name + ':center-servo')
...
class DlMotorStepper:
    ...
    async def perform_referencing(self) -> None:
        await self.__client.exec(self.__name + ':perform-referencing')

    async def reset_cycles(self) -> None:
        await self.__client.exec(self.__name + ':reset-cycles')
...
class DlMotorScan:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._restore_on_end = MutableDecopBoolean(client, name + ':restore-on-end')
    ...
    @property
    def restore_on_end(self) -> 'MutableDecopBoolean':
        return self._restore_on_end
    ...
    async def stop(self) -> None:
        await self.__client.exec(self.__name + ':stop')

    async def pause(self) -> None:
        await self.__client.exec(self.__name + ':pause')

    async def continue_(self) -> None:
        await self.__client.exec(self.__name + ':continue')
...
class DlMotorCalibration:
    ...
    async def set(self, fit_a: float, fit_b: float, fit_c: float, wavelength_min: float, wavelength_max: float) -> None:
        ...
        await self.__client.exec(self.__name + ':set', fit_a, fit_b, fit_c, wavelength_min, wavelength_max)
...
class LhFactory:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._tc = TcFactorySettings2(client, name + ':tc')
        ...
        self._servo_control = ServoControlFactorySettings(client, name + ':servo-control')
        self._powerlock_output_channel_override = MutableDecopInteger(client, name + ':powerlock-output-channel-override')
    ...
    @property
    def tc(self) -> 'TcFactorySettings2':
        return self._tc
    ...
    @property
    def servo_control(self) -> 'ServoControlFactorySettings':
        return self._servo_control

    @property
    def powerlock_output_channel_override(self) -> 'MutableDecopInteger':
        return self._powerlock_output_channel_override
    ...
    async def apply(self) -> None:
        await self.__client.exec(self.__name + ':apply')

    async def retrieve_now(self) -> None:
        await self.__client.exec(self.__name + ':retrieve-now')

    async def update_service_date(self) -> None:
        await self.__client.exec(self.__name + ':update-service-date')
...
class TcFactorySettings2:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._output_inverted = DecopBoolean(client, name + ':output-inverted')
    ...
    @property
    def output_inverted(self) -> 'DecopBoolean':
        return self._output_inverted
...
class ServoControlFactorySettings:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._probe1_hor = MutableDecopString(client, name + ':probe1-hor')
        self._probe1_vert = MutableDecopString(client, name + ':probe1-vert')
        self._ta1_hor = MutableDecopString(client, name + ':ta1-hor')
        self._ta1_vert = MutableDecopString(client, name + ':ta1-vert')
        self._ta2_hor = MutableDecopString(client, name + ':ta2-hor')
        self._ta2_vert = MutableDecopString(client, name + ':ta2-vert')
        self._fiber1_hor = MutableDecopString(client, name + ':fiber1-hor')
        self._fiber1_vert = MutableDecopString(client, name + ':fiber1-vert')
        self._probe_pd = MutableDecopString(client, name + ':probe-pd')
        self._ta_pd = MutableDecopString(client, name + ':ta-pd')
        self._fiber_pd = MutableDecopString(client, name + ':fiber-pd')

    @property
    def probe1_hor(self) -> 'MutableDecopString':
        return self._probe1_hor

    @property
    def probe1_vert(self) -> 'MutableDecopString':
        return self._probe1_vert

    @property
    def ta1_hor(self) -> 'MutableDecopString':
        return self._ta1_hor

    @property
    def ta1_vert(self) -> 'MutableDecopString':
        return self._ta1_vert

    @property
    def ta2_hor(self) -> 'MutableDecopString':
        return self._ta2_hor

    @property
    def ta2_vert(self) -> 'MutableDecopString':
        return self._ta2_vert

    @property
    def fiber1_hor(self) -> 'MutableDecopString':
        return self._fiber1_hor

    @property
    def fiber1_vert(self) -> 'MutableDecopString':
        return self._fiber1_vert

    @property
    def probe_pd(self) -> 'MutableDecopString':
        return self._probe_pd

    @property
    def ta_pd(self) -> 'MutableDecopString':
        return self._ta_pd

    @property
    def fiber_pd(self) -> 'MutableDecopString':
        return self._fiber_pd
...
class CtlOptimizationT:
    ...
    async def smile(self) -> None:
        await self.__client.exec(self.__name + ':smile')

    async def flow(self) -> None:
        await self.__client.exec(self.__name + ':flow')
...
class CtlMotor:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._calibration = CtlMotorCalibration(client, name + ':calibration')
        self._status = DecopInteger(client, name + ':status')
        self._status_txt = DecopString(client, name + ':status-txt')
    ...
    @property
    def calibration(self) -> 'CtlMotorCalibration':
        return self._calibration
...
class CtlMotorCalibration:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._wavelength_offset = MutableDecopReal(client, name + ':wavelength-offset')

    @property
    def wavelength_offset(self) -> 'MutableDecopReal':
        return self._wavelength_offset

    async def shift_wavelength(self, target_wavelength: float) -> None:
        assert isinstance(target_wavelength, float), f"expected type 'float' for parameter 'target_wavelength', got '{type(target_wavelength)}'"
        await self.__client.exec(self.__name + ':shift-wavelength', target_wavelength)

    async def reset_shift(self) -> None:
        await self.__client.exec(self.__name + ':reset-shift')
...
class LaserAmp:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._ontime = DecopInteger(client, name + ':ontime')
        self._ontime_txt = DecopString(client, name + ':ontime-txt')
        self._cc = AmpccHighlevelChannel(client, name + ':cc')
        self._tc = TcChannel1(client, name + ':tc')
    ...
    @property
    def cc(self) -> 'AmpccHighlevelChannel':
        return self._cc
...
class AmpFactoryPower:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._power_max_warning_delay = MutableDecopReal(client, name + ':power-max-warning-delay')
        self._power_max_shutdown_delay = MutableDecopReal(client, name + ':power-max-shutdown-delay')
        self._detect_pd_removal = DecopBoolean(client, name + ':detect-pd-removal')
    ...
    @property
    def detect_pd_removal(self) -> 'DecopBoolean':
        return self._detect_pd_removal
...
class WideScan:
    ...
    async def set_output_to_zoom_offset(self) -> None:
        await self.__client.exec(self.__name + ':set-output-to-zoom-offset')

    async def set_scan_range_to_zoom_range(self) -> None:
        await self.__client.exec(self.__name + ':set-scan-range-to-zoom-range')

    async def set_zoom_range_to_scan_range(self) -> None:
        await self.__client.exec(self.__name + ':set-zoom-range-to-scan-range')
...
class Recorder:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._sample_count_limit = MutableDecopInteger(client, name + ':sample-count-limit')
    ...
    @property
    def sample_count_limit(self) -> 'MutableDecopInteger':
...
class RecorderData:
    ...
    async def zoom_out(self) -> None:
        await self.__client.exec(self.__name + ':zoom-out')
    ...
    async def get_data(self, start_index: int, count: int) -> bytes:
        ...
        return await self.__client.exec(self.__name + ':get-data', start_index, count, return_type=bytes)

    async def show_data(self, start_index: int, count: int) -> None:
        assert isinstance(start_index, int), f"expected type 'int' for parameter 'start_index', got '{type(start_index)}'"
        assert isinstance(count, int), f"expected type 'int' for parameter 'count', got '{type(count)}'"
        await self.__client.exec(self.__name + ':show-data', start_index, count)

    async def clear_data(self) -> None:
        await self.__client.exec(self.__name + ':clear-data')
...
class NloLaserHeadServos:
    ...
    async def center_shg_servos(self) -> None:
        await self.__client.exec(self.__name + ':center-shg-servos')

    async def center_fhg_servos(self) -> None:
        await self.__client.exec(self.__name + ':center-fhg-servos')
...
class NloPowerOptimization:
    ...
    async def start_optimization_shg(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization-shg', return_type=int)

    async def start_optimization_fiber(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization-fiber', return_type=int)

    async def start_optimization_fhg(self) -> int:
        return await self.__client.exec(self.__name + ':start-optimization-fhg', return_type=int)
...
class AutoNlo:
    ...
    async def perform_single_mode_optimization(self) -> None:
        await self.__client.exec(self.__name + ':perform-single-mode-optimization')

    async def perform_auto_align(self) -> None:
        await self.__client.exec(self.__name + ':perform-auto-align')

    async def reset_operation_time_cavity(self) -> None:
        await self.__client.exec(self.__name + ':reset-operation-time-cavity')

    async def reset_operation_time_cavity_fhg(self) -> None:
        await self.__client.exec(self.__name + ':reset-operation-time-cavity-fhg')
...
class NloLaserHeadLockShg1:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._pid_selection = MutableDecopInteger(client, name + ':pid-selection')
        self._setpoint = MutableDecopReal(client, name + ':setpoint')
        self._continuous_calc_pid = MutableDecopBoolean(client, name + ':continuous-calc-pid')
        self._relock = NloLaserHeadRelock1(client, name + ':relock')
        self._window = NloLaserHeadWindow1(client, name + ':window')
        self._calibration = NloLaserHeadCalibration2(client, name + ':calibration')
    ...
    @property
    def continuous_calc_pid(self) -> 'MutableDecopBoolean':
        return self._continuous_calc_pid
    ...
    @property
    def calibration(self) -> 'NloLaserHeadCalibration2':
        return self._calibration
...
class NloLaserHeadCalibration2:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._power_min = MutableDecopReal(client, name + ':power-min')
        self._power_max = MutableDecopReal(client, name + ':power-max')
        self._power_hysteresis = MutableDecopReal(client, name + ':power-hysteresis')
        self._pid2_all_min = MutableDecopReal(client, name + ':pid2-all-min')
        self._pid2_all_max = MutableDecopReal(client, name + ':pid2-all-max')
        self._pid2_p_min = MutableDecopReal(client, name + ':pid2-p-min')
        self._pid2_p_max = MutableDecopReal(client, name + ':pid2-p-max')
        self._pid1_all_min = MutableDecopReal(client, name + ':pid1-all-min')
        self._pid1_all_max = MutableDecopReal(client, name + ':pid1-all-max')
        self._pid1_p_min = MutableDecopReal(client, name + ':pid1-p-min')
        self._pid1_p_max = MutableDecopReal(client, name + ':pid1-p-max')
        self._analog_p_min = MutableDecopReal(client, name + ':analog-p-min')
        self._analog_p_max = MutableDecopReal(client, name + ':analog-p-max')
        self._shg_pdh_rf_gain_min = MutableDecopReal(client, name + ':shg-pdh-rf-gain-min')
        self._shg_pdh_rf_gain_max = MutableDecopReal(client, name + ':shg-pdh-rf-gain-max')
        self._lo_amplitude_min = MutableDecopReal(client, name + ':lo-amplitude-min')
        self._lo_amplitude_max = MutableDecopReal(client, name + ':lo-amplitude-max')
        self._threshold_min = MutableDecopReal(client, name + ':threshold-min')
        self._threshold_max = MutableDecopReal(client, name + ':threshold-max')
    ...
    @property
    def power_hysteresis(self) -> 'MutableDecopReal':
        return self._power_hysteresis

    @property
    def pid2_all_min(self) -> 'MutableDecopReal':
        return self._pid2_all_min

    @property
    def pid2_all_max(self) -> 'MutableDecopReal':
        return self._pid2_all_max

    @property
    def pid2_p_min(self) -> 'MutableDecopReal':
        return self._pid2_p_min

    @property
    def pid2_p_max(self) -> 'MutableDecopReal':
        return self._pid2_p_max

    @property
    def pid1_all_min(self) -> 'MutableDecopReal':
        return self._pid1_all_min

    @property
    def pid1_all_max(self) -> 'MutableDecopReal':
        return self._pid1_all_max

    @property
    def pid1_p_min(self) -> 'MutableDecopReal':
        return self._pid1_p_min

    @property
    def pid1_p_max(self) -> 'MutableDecopReal':
        return self._pid1_p_max

    @property
    def analog_p_min(self) -> 'MutableDecopReal':
        return self._analog_p_min

    @property
    def analog_p_max(self) -> 'MutableDecopReal':
        return self._analog_p_max

    @property
    def shg_pdh_rf_gain_min(self) -> 'MutableDecopReal':
        return self._shg_pdh_rf_gain_min

    @property
    def shg_pdh_rf_gain_max(self) -> 'MutableDecopReal':
        return self._shg_pdh_rf_gain_max

    @property
    def lo_amplitude_min(self) -> 'MutableDecopReal':
        return self._lo_amplitude_min

    @property
    def lo_amplitude_max(self) -> 'MutableDecopReal':
        return self._lo_amplitude_max
...
class NloLaserHeadLocalOscillatorShg1:
    ...
    async def auto_pdh(self) -> None:
        await self.__client.exec(self.__name + ':auto-pdh')

    async def auto_pdh_abort(self) -> None:
        await self.__client.exec(self.__name + ':auto-pdh-abort')
...
class NloLaserHeadLockFactorySettings:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._pid_selection = MutableDecopInteger(client, name + ':pid-selection')
        self._setpoint = MutableDecopReal(client, name + ':setpoint')
        self._calibration = NloLaserHeadCalibration1(client, name + ':calibration')
    ...
    @property
    def calibration(self) -> 'NloLaserHeadCalibration1':
        return self._calibration
...
class NloLaserHeadCalibration1:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._power_min = MutableDecopReal(client, name + ':power-min')
...
class OpoCavity:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._tc = TcChannel1(client, name + ':tc')
        self._pc = PiezoDrv1(client, name + ':pc')
        self._pc_fast = OpoFastPiezo(client, name + ':pc-fast')
    ...
    @property
    def pc_fast(self) -> 'OpoFastPiezo':
        return self._pc_fast
...
class NloLaserHeadMicronixMotor:
    ...
    async def recalibrate(self) -> None:
        await self.__client.exec(self.__name + ':recalibrate')
...
class UvShg:
    ...
    async def perform_optics_shift(self) -> None:
        await self.__client.exec(self.__name + ':perform-optics-shift')

    async def clear_errors(self) -> None:
        await self.__client.exec(self.__name + ':clear-errors')
...
class UvShgOptimizationSettings:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._automatic_optics_shift = MutableDecopBoolean(client, name + ':automatic-optics-shift')
    ...
    @property
    def automatic_optics_shift(self) -> 'MutableDecopBoolean':
        return self._automatic_optics_shift
...
class NloLaserHeadLockShg2:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._continuous_calc_pid = DecopBoolean(client, name + ':continuous-calc-pid')
        self._relock = NloLaserHeadRelock2(client, name + ':relock')
        self._window = NloLaserHeadWindow2(client, name + ':window')
        self._calibration = NloLaserHeadCalibration3(client, name + ':calibration')
    ...
    @property
    def continuous_calc_pid(self) -> 'DecopBoolean':
        return self._continuous_calc_pid
    ...
    @property
    def calibration(self) -> 'NloLaserHeadCalibration3':
        return self._calibration
...
class NloLaserHeadCalibration3:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._power_min = DecopReal(client, name + ':power-min')
        self._power_max = DecopReal(client, name + ':power-max')
        self._power_hysteresis = DecopReal(client, name + ':power-hysteresis')
        self._pid2_all_min = DecopReal(client, name + ':pid2-all-min')
        self._pid2_all_max = DecopReal(client, name + ':pid2-all-max')
        self._pid2_p_min = DecopReal(client, name + ':pid2-p-min')
        self._pid2_p_max = DecopReal(client, name + ':pid2-p-max')
        self._pid1_all_min = DecopReal(client, name + ':pid1-all-min')
        self._pid1_all_max = DecopReal(client, name + ':pid1-all-max')
        self._pid1_p_min = DecopReal(client, name + ':pid1-p-min')
        self._pid1_p_max = DecopReal(client, name + ':pid1-p-max')
        self._analog_p_min = DecopReal(client, name + ':analog-p-min')
        self._analog_p_max = DecopReal(client, name + ':analog-p-max')
        self._shg_pdh_rf_gain_min = DecopReal(client, name + ':shg-pdh-rf-gain-min')
        self._shg_pdh_rf_gain_max = DecopReal(client, name + ':shg-pdh-rf-gain-max')
        self._lo_amplitude_min = DecopReal(client, name + ':lo-amplitude-min')
        self._lo_amplitude_max = DecopReal(client, name + ':lo-amplitude-max')
        self._threshold_min = DecopReal(client, name + ':threshold-min')
        self._threshold_max = DecopReal(client, name + ':threshold-max')
    ...
    @property
    def power_hysteresis(self) -> 'DecopReal':
        return self._power_hysteresis

    @property
    def pid2_all_min(self) -> 'DecopReal':
        return self._pid2_all_min

    @property
    def pid2_all_max(self) -> 'DecopReal':
        return self._pid2_all_max

    @property
    def pid2_p_min(self) -> 'DecopReal':
        return self._pid2_p_min

    @property
    def pid2_p_max(self) -> 'DecopReal':
        return self._pid2_p_max

    @property
    def pid1_all_min(self) -> 'DecopReal':
        return self._pid1_all_min

    @property
    def pid1_all_max(self) -> 'DecopReal':
        return self._pid1_all_max

    @property
    def pid1_p_min(self) -> 'DecopReal':
        return self._pid1_p_min

    @property
    def pid1_p_max(self) -> 'DecopReal':
        return self._pid1_p_max

    @property
    def analog_p_min(self) -> 'DecopReal':
        return self._analog_p_min

    @property
    def analog_p_max(self) -> 'DecopReal':
        return self._analog_p_max

    @property
    def shg_pdh_rf_gain_min(self) -> 'DecopReal':
        return self._shg_pdh_rf_gain_min

    @property
    def shg_pdh_rf_gain_max(self) -> 'DecopReal':
        return self._shg_pdh_rf_gain_max

    @property
    def lo_amplitude_min(self) -> 'DecopReal':
        return self._lo_amplitude_min

    @property
    def lo_amplitude_max(self) -> 'DecopReal':
        return self._lo_amplitude_max
...
class HfCavity:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._tc1 = TcChannel1(client, name + ':tc1')
        self._tc2 = TcChannel1(client, name + ':tc2')
        self._factory_settings = HfCavityFactory(client, name + ':factory-settings')

    @property
    def tc1(self) -> 'TcChannel1':
        return self._tc1

    @property
    def tc2(self) -> 'TcChannel1':
        return self._tc2

    @property
    def factory_settings(self) -> 'HfCavityFactory':
        return self._factory_settings
...
class HfCavityFactory:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._tc1 = TcFactorySettings1(client, name + ':tc1')
        self._tc2 = TcFactorySettings1(client, name + ':tc2')
        self._last_modified = DecopString(client, name + ':last-modified')
        self._modified = DecopBoolean(client, name + ':modified')

    @property
    def tc1(self) -> 'TcFactorySettings1':
        return self._tc1

    @property
    def tc2(self) -> 'TcFactorySettings1':
        return self._tc2
...
class LaserConfig:
    ...
    async def load(self, source: str) -> None:
        ...
        await self.__client.exec(self.__name + ':load', source)
    ...
    async def save(self, destination: str) -> None:
        ...
        await self.__client.exec(self.__name + ':save', destination)
    ...
    async def import_(self, input_stream: bytes) -> None:
        ...
        await self.__client.exec(self.__name + ':import', input_stream=input_stream)

    async def export(self) -> bytes:
        return await self.__client.exec(self.__name + ':export', output_type=bytes)

    async def retrieve(self) -> None:
        await self.__client.exec(self.__name + ':retrieve')

    async def apply(self) -> bool:
        return await self.__client.exec(self.__name + ':apply', return_type=bool)

    async def show(self) -> str:
        return await self.__client.exec(self.__name + ':show', output_type=str)

    async def list(self) -> str:
        return await self.__client.exec(self.__name + ':list', return_type=str)
...
class LaserDiagnosis:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._smc_scan = LaserDiagnosisSmcScan(client, name + ':smc-scan')
    ...
    @property
    def smc_scan(self) -> 'LaserDiagnosisSmcScan':
        return self._smc_scan
...
class LaserDiagnosisOptions:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._piezo_test = MutableDecopBoolean(client, name + ':piezo-test')
        self._smc_scan = MutableDecopBoolean(client, name + ':smc-scan')
    ...
    @property
    def piezo_test(self) -> 'MutableDecopBoolean':
        return self._piezo_test

    @property
    def smc_scan(self) -> 'MutableDecopBoolean':
        return self._smc_scan


class LaserDiagnosisSmcScan:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._active = DecopBoolean(client, name + ':active')
        self._progress = DecopInteger(client, name + ':progress')
        self._settle_time = MutableDecopInteger(client, name + ':settle-time')
        self._current_step = MutableDecopReal(client, name + ':current-step')
        self._voltage_step = MutableDecopReal(client, name + ':voltage-step')

    @property
    def active(self) -> 'DecopBoolean':
        return self._active
    ...
    @property
    def settle_time(self) -> 'MutableDecopInteger':
        return self._settle_time

    @property
    def current_step(self) -> 'MutableDecopReal':
        return self._current_step

    @property
    def voltage_step(self) -> 'MutableDecopReal':
...
class LaserCommon:
    ...
    async def save_all(self) -> None:
        await self.__client.exec(self.__name + ':save-all')

    async def load_all(self) -> None:
        await self.__client.exec(self.__name + ':load-all')

    async def store_all(self) -> None:
        await self.__client.exec(self.__name + ':store-all')

    async def restore_all(self) -> None:
        await self.__client.exec(self.__name + ':restore-all')

    async def apply_all(self) -> None:
        await self.__client.exec(self.__name + ':apply-all')

    async def retrieve_all(self) -> None:
        await self.__client.exec(self.__name + ':retrieve-all')
...
class ScanSynchronization:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._sync_laser3 = MutableDecopBoolean(client, name + ':sync-laser3')
        self._sync_laser4 = MutableDecopBoolean(client, name + ':sync-laser4')
        self._frequency = MutableDecopReal(client, name + ':frequency')
    ...
    @property
    def sync_laser3(self) -> 'MutableDecopBoolean':
        return self._sync_laser3

    @property
    def sync_laser4(self) -> 'MutableDecopBoolean':
        return self._sync_laser4
    ...
    async def sync(self) -> None:
        await self.__client.exec(self.__name + ':sync')
...
class AutoNloToplevel:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._fw_ver_valid = DecopBoolean(client, name + ':fw-ver-valid')
        self._customer = DecopString(client, name + ':customer')
        self._laser_on = MutableDecopBoolean(client, name + ':laser-on')
        self._emission = DecopBoolean(client, name + ':emission')
        self._status = DecopInteger(client, name + ':status')
        self._status_txt = DecopString(client, name + ':status-txt')
        ...
        self._voltage_act_shg = DecopReal(client, name + ':voltage-act-shg')
        self._air_pressure = DecopReal(client, name + ':air-pressure')
        self._amplifier_current_margin = DecopReal(client, name + ':amplifier-current-margin')
        self._conversion_efficiency = DecopReal(client, name + ':conversion-efficiency')
        self._conversion_efficiency_fhg = DecopReal(client, name + ':conversion-efficiency-fhg')
        ...
        self._power_act = DecopReal(client, name + ':power-act')
        self._wavelength_set = MutableDecopReal(client, name + ':wavelength-set')
        self._wavelength_set_min = DecopReal(client, name + ':wavelength-set-min')
        self._wavelength_set_max = DecopReal(client, name + ':wavelength-set-max')
        self._wavelength = DecopReal(client, name + ':wavelength')
        self._idle_mode = MutableDecopBoolean(client, name + ':idle-mode')
        self._wavemeter = AutoNloWavemeter(client, name + ':wavemeter')
    ...
    @property
    def fw_ver_valid(self) -> 'DecopBoolean':
        return self._fw_ver_valid

    @property
    def customer(self) -> 'DecopString':
    ...
    @property
    def voltage_act_shg(self) -> 'DecopReal':
        return self._voltage_act_shg
    ...
    @property
    def wavelength_set_min(self) -> 'DecopReal':
        return self._wavelength_set_min

    @property
    def wavelength_set_max(self) -> 'DecopReal':
        return self._wavelength_set_max
...
class CcBoard:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._smc_support = DecopBoolean(client, name + ':smc-support')
        self._status = DecopInteger(client, name + ':status')
        self._status_txt = DecopString(client, name + ':status-txt')
    ...
    @property
    def smc_support(self) -> 'DecopBoolean':
        return self._smc_support
...
class IoOutputChannel:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._voltage_min = MutableDecopReal(client, name + ':voltage-min')
        self._voltage_max = MutableDecopReal(client, name + ':voltage-max')
        self._signal_monitor = IoMonitor(client, name + ':signal-monitor')
        self._output_filter = OutputFilter1(client, name + ':output-filter')
    ...
    @property
    def signal_monitor(self) -> 'IoMonitor':
...
class IoMonitor:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self.__name = name
        self._signal = MutableDecopInteger(client, name + ':signal')
        self._operating_point = MutableDecopReal(client, name + ':operating-point')
        self._factor = MutableDecopReal(client, name + ':factor')
        self._enabled = MutableDecopBoolean(client, name + ':enabled')
    ...
    @property
    def operating_point(self) -> 'MutableDecopReal':
...
class SiBoard:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._serial_number = DecopString(client, name + ':serial-number')
        self._revision = DecopString(client, name + ':revision')
        self._si1_input_signal = DecopBoolean(client, name + ':si1-input-signal')
        self._si2_enabled = DecopBoolean(client, name + ':si2-enabled')
    ...
    @property
    def si1_input_signal(self) -> 'DecopBoolean':
        return self._si1_input_signal

    @property
    def si2_enabled(self) -> 'DecopBoolean':
        return self._si2_enabled
...
class Display:
    ...
    async def update_state(self, active: bool) -> None:
        ...
        await self.__client.exec(self.__name + ':update-state', active)
...
class Standby:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._laser3 = StandbyLaser3(client, name + ':laser3')
        self._laser4 = StandbyLaser3(client, name + ':laser4')
    ...
    @property
    def laser3(self) -> 'StandbyLaser3':
        return self._laser3

    @property
    def laser4(self) -> 'StandbyLaser3':
        return self._laser4
...
class DigifalcBoard:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._revision = DecopString(client, name + ':revision')
        self._boot_ver = DecopInteger(client, name + ':boot-ver')
        self._fw_ver = DecopString(client, name + ':fw-ver')
        self._board_temp = DecopReal(client, name + ':board-temp')
        self._status = DecopInteger(client, name + ':status')
        self._status_txt = DecopString(client, name + ':status-txt')
    ...
    @property
    def boot_ver(self) -> 'DecopInteger':
...
class DlMotorBoard:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._io = DlMotorIo(client, name + ':io')
...
class DlMotorIo:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._digital_in0 = DlMotorDigitalInput(client, name + ':digital-in0')
        self._digital_in1 = DlMotorDigitalInput(client, name + ':digital-in1')
        self._digital_in2 = DlMotorDigitalInput(client, name + ':digital-in2')
        self._digital_in3 = DlMotorDigitalInput(client, name + ':digital-in3')
        self._digital_out0 = DlMotorDigitalOutput(client, name + ':digital-out0')
        self._digital_out1 = DlMotorDigitalOutput(client, name + ':digital-out1')
        self._digital_out2 = DlMotorDigitalOutput(client, name + ':digital-out2')
        self._digital_out3 = DlMotorDigitalOutput(client, name + ':digital-out3')

    @property
    def digital_in0(self) -> 'DlMotorDigitalInput':
        return self._digital_in0

    @property
    def digital_in1(self) -> 'DlMotorDigitalInput':
        return self._digital_in1

    @property
    def digital_in2(self) -> 'DlMotorDigitalInput':
        return self._digital_in2

    @property
    def digital_in3(self) -> 'DlMotorDigitalInput':
        return self._digital_in3

    @property
    def digital_out0(self) -> 'DlMotorDigitalOutput':
        return self._digital_out0

    @property
    def digital_out1(self) -> 'DlMotorDigitalOutput':
        return self._digital_out1

    @property
    def digital_out2(self) -> 'DlMotorDigitalOutput':
        return self._digital_out2

    @property
    def digital_out3(self) -> 'DlMotorDigitalOutput':
        return self._digital_out3


class DlMotorDigitalInput:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._value_act = DecopBoolean(client, name + ':value-act')
...
class PfdBoard:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._status = DecopInteger(client, name + ':status')
        self._status_txt = DecopString(client, name + ':status-txt')
        self._external_clock_detected = DecopBoolean(client, name + ':external-clock-detected')
        self._external_clock_locked = DecopBoolean(client, name + ':external-clock-locked')
        self._rf_path = MutableDecopInteger(client, name + ':rf-path')
        self._reference_path = MutableDecopInteger(client, name + ':reference-path')
        self._dds_output_enabled = MutableDecopBoolean(client, name + ':dds-output-enabled')
        self._phase_out_filter_enabled = MutableDecopBoolean(client, name + ':phase-out-filter-enabled')
        self._aux_out1_signal = MutableDecopInteger(client, name + ':aux-out1-signal')
        self._aux_out2_signal = MutableDecopInteger(client, name + ':aux-out2-signal')
        self._frequency_counters = PfdFrequencyCounters(client, name + ':frequency-counters')
        self._frequency_plan = PfdFrequencyPlan(client, name + ':frequency-plan')
        self._reference_frequency = PfdReferenceFrequency(client, name + ':reference-frequency')
        self._cavity_bridge = PfdCavityBridge(client, name + ':cavity-bridge')
        self._lf = PfdLf(client, name + ':lf')
        self._hf = PfdHf(client, name + ':hf')
        self._event_detector = PfdEventDetector(client, name + ':event-detector')
        self._digital_io = PfdIo(client, name + ':digital-io')
        self._user_led_mode = MutableDecopInteger(client, name + ':user-led-mode')
    ...
    @property
    def external_clock_detected(self) -> 'DecopBoolean':
        return self._external_clock_detected

    @property
    def external_clock_locked(self) -> 'DecopBoolean':
        return self._external_clock_locked

    @property
    def rf_path(self) -> 'MutableDecopInteger':
        return self._rf_path

    @property
    def reference_path(self) -> 'MutableDecopInteger':
        return self._reference_path

    @property
    def dds_output_enabled(self) -> 'MutableDecopBoolean':
        return self._dds_output_enabled

    @property
    def phase_out_filter_enabled(self) -> 'MutableDecopBoolean':
        return self._phase_out_filter_enabled

    @property
    def aux_out1_signal(self) -> 'MutableDecopInteger':
        return self._aux_out1_signal

    @property
    def aux_out2_signal(self) -> 'MutableDecopInteger':
        return self._aux_out2_signal

    @property
    def frequency_counters(self) -> 'PfdFrequencyCounters':
        return self._frequency_counters

    @property
    def frequency_plan(self) -> 'PfdFrequencyPlan':
        return self._frequency_plan

    @property
    def reference_frequency(self) -> 'PfdReferenceFrequency':
        return self._reference_frequency

    @property
    def cavity_bridge(self) -> 'PfdCavityBridge':
    ...
    @property
    def event_detector(self) -> 'PfdEventDetector':
        return self._event_detector

    @property
    def digital_io(self) -> 'PfdIo':
        return self._digital_io

    @property
    def user_led_mode(self) -> 'MutableDecopInteger':
        return self._user_led_mode
...
class PfdFrequencyCounters:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._gating_time = MutableDecopInteger(client, name + ':gating-time')
        self._reference_frequency = DecopInteger(client, name + ':reference-frequency')
        self._counter_output_frequency = DecopInteger(client, name + ':counter-output-frequency')
        self._lf_frequency = DecopInteger(client, name + ':lf-frequency')
        self._phase_output_frequency = DecopInteger(client, name + ':phase-output-frequency')

    @property
    def gating_time(self) -> 'MutableDecopInteger':
        return self._gating_time

    @property
    def reference_frequency(self) -> 'DecopInteger':
        return self._reference_frequency

    @property
    def counter_output_frequency(self) -> 'DecopInteger':
        return self._counter_output_frequency

    @property
    def lf_frequency(self) -> 'DecopInteger':
        return self._lf_frequency

    @property
    def phase_output_frequency(self) -> 'DecopInteger':
        return self._phase_output_frequency


class PfdFrequencyPlan:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._mode = MutableDecopInteger(client, name + ':mode')
        self._center_frequency = MutableDecopReal(client, name + ':center-frequency')
        self._scan = PfdFplanScan(client, name + ':scan')
        self._hopping = PfdFplanHop(client, name + ':hopping')
    ...
    @property
    def center_frequency(self) -> 'MutableDecopReal':
        return self._center_frequency

    @property
    def scan(self) -> 'PfdFplanScan':
        return self._scan

    @property
    def hopping(self) -> 'PfdFplanHop':
...
class PfdFplanScan:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._ramp_rate = MutableDecopReal(client, name + ':ramp-rate')
    ...
    @property
    def ramp_rate(self) -> 'MutableDecopReal':
...
class PfdFplanHop:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._frequency1 = MutableDecopReal(client, name + ':frequency1')
        self._frequency2 = MutableDecopReal(client, name + ':frequency2')
        self._frequency3 = MutableDecopReal(client, name + ':frequency3')
        self._frequency4 = MutableDecopReal(client, name + ':frequency4')
        self._feed_forward_offset = MutableDecopReal(client, name + ':feed-forward-offset')
        self._feed_forward_factor = MutableDecopReal(client, name + ':feed-forward-factor')

    @property
    def frequency1(self) -> 'MutableDecopReal':
        return self._frequency1

    @property
    def frequency2(self) -> 'MutableDecopReal':
        return self._frequency2

    @property
    def frequency3(self) -> 'MutableDecopReal':
        return self._frequency3

    @property
    def frequency4(self) -> 'MutableDecopReal':
        return self._frequency4

    @property
    def feed_forward_offset(self) -> 'MutableDecopReal':
        return self._feed_forward_offset

    @property
    def feed_forward_factor(self) -> 'MutableDecopReal':
        return self._feed_forward_factor


class PfdReferenceFrequency:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._center_frequency = DecopReal(client, name + ':center-frequency')
        self._scan = PfdRefFreqScan(client, name + ':scan')
        self._hopping = PfdRefFreqHop(client, name + ':hopping')

    @property
    def center_frequency(self) -> 'DecopReal':
        return self._center_frequency

    @property
    def scan(self) -> 'PfdRefFreqScan':
        return self._scan

    @property
    def hopping(self) -> 'PfdRefFreqHop':
        return self._hopping


class PfdRefFreqScan:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._amplitude = DecopReal(client, name + ':amplitude')
        self._ramp_rate = DecopReal(client, name + ':ramp-rate')
...
class PfdRefFreqHop:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._frequency1 = DecopReal(client, name + ':frequency1')
        self._frequency2 = DecopReal(client, name + ':frequency2')
        self._frequency3 = DecopReal(client, name + ':frequency3')
        self._frequency4 = DecopReal(client, name + ':frequency4')
        self._feed_forward_offset = DecopReal(client, name + ':feed-forward-offset')
        self._feed_forward_factor = DecopReal(client, name + ':feed-forward-factor')

    @property
    def frequency1(self) -> 'DecopReal':
        return self._frequency1

    @property
    def frequency2(self) -> 'DecopReal':
        return self._frequency2

    @property
    def frequency3(self) -> 'DecopReal':
        return self._frequency3

    @property
    def frequency4(self) -> 'DecopReal':
        return self._frequency4

    @property
    def feed_forward_offset(self) -> 'DecopReal':
        return self._feed_forward_offset

    @property
    def feed_forward_factor(self) -> 'DecopReal':
        return self._feed_forward_factor


class PfdCavityBridge:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._output_enabled = MutableDecopBoolean(client, name + ':output-enabled')
        self._external_trigger_enabled = MutableDecopBoolean(client, name + ':external-trigger-enabled')
        self._output_frequency = MutableDecopReal(client, name + ':output-frequency')
        self._scan_enabled = MutableDecopBoolean(client, name + ':scan-enabled')
        self._end_frequency = MutableDecopReal(client, name + ':end-frequency')
        self._step_size = MutableDecopReal(client, name + ':step-size')
        self._ramp_rate = MutableDecopReal(client, name + ':ramp-rate')
    ...
    @property
    def external_trigger_enabled(self) -> 'MutableDecopBoolean':
        return self._external_trigger_enabled

    @property
    def output_frequency(self) -> 'MutableDecopReal':
        return self._output_frequency

    @property
    def scan_enabled(self) -> 'MutableDecopBoolean':
        return self._scan_enabled

    @property
    def end_frequency(self) -> 'MutableDecopReal':
        return self._end_frequency

    @property
    def step_size(self) -> 'MutableDecopReal':
...
class PfdLf:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._r_divider = MutableDecopInteger(client, name + ':r-divider')
        self._n_divider = MutableDecopInteger(client, name + ':n-divider')
        self._input_filter_enabled = MutableDecopBoolean(client, name + ':input-filter-enabled')
        self._input_level = DecopReal(client, name + ':input-level')
        self._input_gain = MutableDecopReal(client, name + ':input-gain')
        self._signal_level = DecopReal(client, name + ':signal-level')
        self._current_gain = MutableDecopInteger(client, name + ':current-gain')
        self._polarity = MutableDecopBoolean(client, name + ':polarity')
        self._tunable_filter_enabled = MutableDecopBoolean(client, name + ':tunable-filter-enabled')
        self._tunable_filter_center_frequency = MutableDecopReal(client, name + ':tunable-filter-center-frequency')
        self._agc = PfdAgc(client, name + ':agc')
        self._frequency_deviation = PfdFrequencyDeviation(client, name + ':frequency-deviation')

    @property
    def r_divider(self) -> 'MutableDecopInteger':
        return self._r_divider

    @property
    def n_divider(self) -> 'MutableDecopInteger':
        return self._n_divider

    @property
    def input_filter_enabled(self) -> 'MutableDecopBoolean':
        return self._input_filter_enabled

    @property
    def input_level(self) -> 'DecopReal':
        return self._input_level

    @property
    def input_gain(self) -> 'MutableDecopReal':
        return self._input_gain

    @property
    def signal_level(self) -> 'DecopReal':
        return self._signal_level

    @property
    def current_gain(self) -> 'MutableDecopInteger':
        return self._current_gain

    @property
    def polarity(self) -> 'MutableDecopBoolean':
        return self._polarity

    @property
    def tunable_filter_enabled(self) -> 'MutableDecopBoolean':
        return self._tunable_filter_enabled

    @property
    def tunable_filter_center_frequency(self) -> 'MutableDecopReal':
        return self._tunable_filter_center_frequency
    ...
    @property
    def frequency_deviation(self) -> 'PfdFrequencyDeviation':
...
class PfdAgc:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self.__name = name
        self._enabled = MutableDecopBoolean(client, name + ':enabled')
        self._set_level = MutableDecopReal(client, name + ':set-level')
        self._p_gain = MutableDecopReal(client, name + ':p-gain')
        self._i_gain = MutableDecopReal(client, name + ':i-gain')
        self._d_gain = MutableDecopReal(client, name + ':d-gain')
    ...
    @property
    def set_level(self) -> 'MutableDecopReal':
...
class PfdFrequencyDeviation:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._value = DecopInteger(client, name + ':value')
        self._analog_output_scaling = MutableDecopReal(client, name + ':analog-output-scaling')
    ...
    @property
    def analog_output_scaling(self) -> 'MutableDecopReal':
        return self._analog_output_scaling
...
class PfdHf:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._r_divider = MutableDecopInteger(client, name + ':r-divider')
        self._n_divider = MutableDecopInteger(client, name + ':n-divider')
        self._rfdiv2_enabled = MutableDecopBoolean(client, name + ':rfdiv2-enabled')
        self._current_gain = MutableDecopInteger(client, name + ':current-gain')
        self._polarity = MutableDecopBoolean(client, name + ':polarity')
    ...
    @property
    def rfdiv2_enabled(self) -> 'MutableDecopBoolean':
        return self._rfdiv2_enabled
...
class PfdEventDetector:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._phase_error = DecopReal(client, name + ':phase-error')
        self._counter = DecopInteger(client, name + ':counter')
        self._indicator = DecopBoolean(client, name + ':indicator')
        self._indicator_auto_reset_enabled = MutableDecopBoolean(client, name + ':indicator-auto-reset-enabled')
        self._indicator_auto_reset_time = MutableDecopInteger(client, name + ':indicator-auto-reset-time')
    ...
    @property
    def counter(self) -> 'DecopInteger':
        return self._counter

    @property
    def indicator(self) -> 'DecopBoolean':
        return self._indicator

    @property
    def indicator_auto_reset_enabled(self) -> 'MutableDecopBoolean':
        return self._indicator_auto_reset_enabled

    @property
    def indicator_auto_reset_time(self) -> 'MutableDecopInteger':
        return self._indicator_auto_reset_time

    async def reset_counter(self) -> None:
        await self.__client.exec(self.__name + ':reset-counter')

    async def reset_indicator(self) -> None:
        await self.__client.exec(self.__name + ':reset-indicator')
...
class PfdIo:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
        self._in0 = DecopBoolean(client, name + ':in0')
        self._in1 = DecopBoolean(client, name + ':in1')
        self._in2 = DecopBoolean(client, name + ':in2')
        self._in3 = DecopBoolean(client, name + ':in3')
        self._out0 = MutableDecopBoolean(client, name + ':out0')
        self._out1 = MutableDecopBoolean(client, name + ':out1')
        self._out2 = MutableDecopBoolean(client, name + ':out2')
        self._out3 = MutableDecopBoolean(client, name + ':out3')

    @property
    def in0(self) -> 'DecopBoolean':
        return self._in0

    @property
    def in1(self) -> 'DecopBoolean':
        return self._in1

    @property
    def in2(self) -> 'DecopBoolean':
        return self._in2

    @property
    def in3(self) -> 'DecopBoolean':
        return self._in3

    @property
    def out0(self) -> 'MutableDecopBoolean':
        return self._out0

    @property
    def out1(self) -> 'MutableDecopBoolean':
        return self._out1

    @property
    def out2(self) -> 'MutableDecopBoolean':
        return self._out2

    @property
    def out3(self) -> 'MutableDecopBoolean':
        return self._out3
...
class SystemMessages:
    ...
    async def mark_as_read(self, id_: int) -> None:
        ...
        await self.__client.exec(self.__name + ':mark-as-read', id_)

    async def show_all(self) -> str:
        return await self.__client.exec(self.__name + ':show-all', output_type=str)

    async def show_new(self) -> str:
        return await self.__client.exec(self.__name + ':show-new', output_type=str)

    async def show_log(self) -> str:
        return await self.__client.exec(self.__name + ':show-log', output_type=str)

    async def show_persistent(self) -> str:
        return await self.__client.exec(self.__name + ':show-persistent', output_type=str)
...
class Licenses:
    ...
    async def get_key(self, key_number: int) -> str:
        ...
        return await self.__client.exec(self.__name + ':get-key', key_number, return_type=str)
    ...
    async def install(self, licensekey: str) -> bool:
        ...
        return await self.__client.exec(self.__name + ':install', licensekey, return_type=bool)
...
class LicenseOptions:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._pfd1_hf_port = LicenseOption(client, name + ':pfd1-hf-port')
        self._pfd2_hf_port = LicenseOption(client, name + ':pfd2-hf-port')
        self._pfd3_hf_port = LicenseOption(client, name + ':pfd3-hf-port')
        self._pfd4_hf_port = LicenseOption(client, name + ':pfd4-hf-port')
    ...
    @property
    def pfd1_hf_port(self) -> 'LicenseOption':
        return self._pfd1_hf_port

    @property
    def pfd2_hf_port(self) -> 'LicenseOption':
        return self._pfd2_hf_port

    @property
    def pfd3_hf_port(self) -> 'LicenseOption':
        return self._pfd3_hf_port

    @property
    def pfd4_hf_port(self) -> 'LicenseOption':
        return self._pfd4_hf_port
...
class FwUpdate:
    ...
    async def upload(self, input_stream: bytes, filename: str) -> None:
        ...
        await self.__client.exec(self.__name + ':upload', filename, input_stream=input_stream)

    async def show_log(self) -> str:
        return await self.__client.exec(self.__name + ':show-log', output_type=str)

    async def show_history(self) -> str:
        return await self.__client.exec(self.__name + ':show-history', output_type=str)
...
class ServiceReport:
    ...
    async def service_report(self) -> bytes:
        return await self.__client.exec(self.__name + ':service-report', output_type=bytes)

    async def request(self) -> None:
        await self.__client.exec(self.__name + ':request')

    async def add_info(self, text: str) -> None:
        assert isinstance(text, str), f"expected type 'str' for parameter 'text', got '{type(text)}'"
        await self.__client.exec(self.__name + ':add-info', text)

    async def print(self) -> bytes:
        return await self.__client.exec(self.__name + ':print', output_type=bytes)

    async def save_to_usb(self) -> None:
        await self.__client.exec(self.__name + ':save-to-usb')
...
class Ipconfig:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._hostname = MutableDecopString(client, name + ':hostname')
    ...
    async def set_dhcp(self) -> None:
        await self.__client.exec(self.__name + ':set-dhcp')
    ...
    async def set_ip(self, ip_addr: str, net_mask: str) -> None:
        ...
        await self.__client.exec(self.__name + ':set-ip', ip_addr, net_mask)
    ...
    async def set_ip_gateway(self, ip_addr: str, net_mask: str, gateway: str) -> None:
        ...
        await self.__client.exec(self.__name + ':set-ip-gateway', ip_addr, net_mask, gateway)
...
class DLCpro:
    def __init__(self, connection: Connection) -> None:
        ...
        self._cc3 = CcBoard(self.__client, 'cc3')
        self._cc4 = CcBoard(self.__client, 'cc4')
        ...
        self._si = SiBoard(self.__client, 'si')
        ...
        self._pdh2 = PdhBoard(self.__client, 'pdh2')
        ...
        self._pfd1 = PfdBoard(self.__client, 'pfd1')
        self._pfd2 = PfdBoard(self.__client, 'pfd2')
        self._pfd3 = PfdBoard(self.__client, 'pfd3')
        self._pfd4 = PfdBoard(self.__client, 'pfd4')
    ...
    @property
    def cc3(self) -> 'CcBoard':
        return self._cc3

    @property
    def cc4(self) -> 'CcBoard':
        return self._cc4
    ...
    @property
    def pfd1(self) -> 'PfdBoard':
        return self._pfd1

    @property
    def pfd2(self) -> 'PfdBoard':
        return self._pfd2

    @property
    def pfd3(self) -> 'PfdBoard':
        return self._pfd3

    @property
    def pfd4(self) -> 'PfdBoard':
        return self._pfd4
    ...
    async def system_connections(self) -> Tuple[str, int]:
        return await self.__client.exec('system-connections', output_type=str, return_type=int)

    async def debug_log(self) -> str:
        return await self.__client.exec('debug-log', output_type=str)

    async def error_log(self) -> str:
        return await self.__client.exec('error-log', output_type=str)

    async def service_log(self) -> str:
        return await self.__client.exec('service-log', output_type=str)

    async def service_script(self, input_stream: bytes) -> None:
        assert isinstance(input_stream, bytes), f"expected type 'bytes' for parameter 'input_stream', got '{type(input_stream)}'"
        await self.__client.exec('service-script', input_stream=input_stream)

    async def service_script_from_usb(self) -> None:
        await self.__client.exec('service-script-from-usb')

    async def service_report(self) -> bytes:
        return await self.__client.exec('service-report', output_type=bytes)

    async def output_signals_report(self) -> None:
        await self.__client.exec('output-signals-report')

    async def system_summary(self) -> str:
        return await self.__client.exec('system-summary', output_type=str)

    async def system_summary_ontimes(self) -> str:
        return await self.__client.exec('system-summary-ontimes', output_type=str)
