# Generated from 'v1_4_0.xml' on 2025-07-21 10:00:17.698288
...
class Laser:
    ...
    async def detect(self) -> None:
        await self.__client.exec(self.__name + ':detect')
...
class Lock:
    ...
    async def start_scan(self) -> None:
        await self.__client.exec(self.__name + ':start-scan')

    async def stop_scan(self) -> None:
        await self.__client.exec(self.__name + ':stop-scan')
