# Generated from 'v3_2_0.xml' on 2025-07-21 10:00:24.396731
...
class LaserDiagnosis:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._mode_map = LaserDiagnosisModeMap(client, name + ':mode-map')
    ...
    @property
    def mode_map(self) -> 'LaserDiagnosisModeMap':
...
class LaserDiagnosisOptions:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._mode_map = MutableDecopBoolean(client, name + ':mode-map')
    ...
    @property
    def mode_map(self) -> 'MutableDecopBoolean':
        return self._mode_map


class LaserDiagnosisModeMap:
    def __init__(self, client: Client, name: str) -> None:
        self.__client = client
        self.__name = name
...
class StandbyLaser1:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._fiber_amp = StandbyFiberAmp(client, name + ':fiber-amp')
    ...
    @property
    def fiber_amp(self) -> 'StandbyFiberAmp':
        return self._fiber_amp
