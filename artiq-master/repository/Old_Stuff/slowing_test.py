...
class Slowing_Test(EnvExperiment):
    ...
    def prepare(self):
        ...
        self.config_dict = [
                ...
                {'par' : 'cooling_offet', 'val' : self.setpoint_offset, 'cmt' : 'Cooling laser offset'},
                {'par' : 'slowing_offset', 'val' : self.slowing_set, 'cmt' : 'Slowing laser offset'}
                ]
