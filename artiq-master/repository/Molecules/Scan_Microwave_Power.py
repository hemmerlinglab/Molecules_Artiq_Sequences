...
class Scan_Microwave_Power(EnvExperiment):
    ...
    def run(self):
        ...
        self.microwave.freq(self.microwave_frequency * 1.0e6) 
        ...
        for n, nu in enumerate(self.scan_interval):
            ...
            # scan microwave power
            self.current_setpoint = nu

            self.microwave.power(self.current_setpoint) 
