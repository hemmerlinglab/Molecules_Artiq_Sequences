...
class DDS_General_Scan(EnvExperiment):
    ...
    def build(self):
        ...
        my_setattr(self,'frequency', NumberValue(default = 0, unit='MHz', min = 0.0, max = 800.0, scale=1,ndecimals=3,step=1))
        ...
        my_setattr(self,'dc_offset', NumberValue(default = 0, unit='V', min = 0.0, max = 0.5, scale=1,ndecimals=3,step=1))
    ...
    def base_run(self, new_freq):
        ...
        self.dds.set(frequency = new_freq * MHz)
    ...
    def run(self):
        ...
        self.scan_interval = np.linspace(10, 400, 3)
